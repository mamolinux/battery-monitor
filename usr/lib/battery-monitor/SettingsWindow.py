...
class SettingsWindow(Gtk.Window):
	...
	def __configuration_page(self):
		...
		label7 = Gtk.Label(_('Success Shown'))
		label7.set_justify(Gtk.Justification.LEFT)
		# label7.set_editable(False)
		...
		self.entry7.set_text(str(self.success_shown))
		self.entry7.set_tooltip_text(_('Shows whether success notification is shown. Set it to "yes" or "ye" or "y" or their corresponding uppercase combinations to stop showing success notification.'))
	...
	def __save_config(self, widget):
		...
		self.config['settings'] = {
			...
			'success_shown': self.entry7.get_text()
		}
